    ...
    public function get_employee($id) {
        try {
            ...
            return [
                ...
                "companyId" => $employee->companyDetails,
                ...
                "otId" => $employee->overtimeRules,
                "lunchBreak" => $employee->lunchBreak,
                "workingHoursIncludeLunch" => $employee->workingHoursIncludeLunch,
                "weeklyOffId" => $employee->weeklyOff,
                "holidayTemplateId" => $employee->holidayTemplates,
